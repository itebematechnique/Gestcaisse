...
{{--                                <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>--}}
                                <li class="breadcrumb-item"><a href="#" class="text-primary">Nouveau bénéficiaire</a></li>
                            </ol>
                        </nav>
                    </div>
    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <h3 class="mb-0">Ajouter un bénéficiaire</h3>
        </div>
        <!-- Form -->
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                <form role="form" method="POST" action="{{ route('beneficiaries.store') }}">
                    @csrf
                    ...
                    <div class="form-group{{ $errors->has('beneficiaire') ? ' has-danger' : '' }} mb-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control{{ $errors->has('beneficiaire') ? ' is-invalid' : '' }}"
                                ...
                                value="{{ old('beneficiaire') }}" value="hacker" required autofocus>
                        </div>
