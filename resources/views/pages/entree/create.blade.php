    ...
    <div class="card">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                <form role="form" method="POST" action="{{ route('entrees.store') }}">
                    @csrf
                    ...
                    <div class="form-group{{ $errors->has('mt_d') ? ' has-danger' : '' }} mb-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control{{ $errors->has('mt_d') ? ' is-invalid' : '' }}"
                                placeholder="{{ __('Montant demandé') }}" type="number" name="mt_d" value="{{ old('mt_d') }}"
                                required autofocus>
                        </div>
                        @if ($errors->has('mt_d'))
                    ...
                    <div class="form-group{{ $errors->has('mt_a') ? ' has-danger' : '' }} mb-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control{{ $errors->has('mt_a') ? ' is-invalid' : '' }}"
                                placeholder="{{ __('Montant accordé') }}" type="number" name="mt_a" value="{{ old('mt_a') }}"
                                required autofocus>
                        </div>
                        @if ($errors->has('mt_a'))
                            <span class="invalid-feedback" style="display: block;" role="alert">
