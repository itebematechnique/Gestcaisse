...
{{--                                <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>--}}
                                <li class="breadcrumb-item"><a href="#" class="text-primary">Mettre à jour un motif</a></li>
                            </ol>
                        </nav>
                    </div>
    ...
    <div class="card">
        ...
        <div class="card card-frame mx-2 my--2 text-sm border-primary bg-primary-lighter">
            <div class="card-body text-primary">
                <i class="ni ni-air-baloon"></i> Mettez à jour votre motif en remplissant le champs ci-dessous
            </div>
        </div>

        <!-- Card header -->
        <div class="card-header border-0">
            <h3 class="mb-0">Mettre à jour le motif</h3>
        </div>
        <!-- Form -->
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                <form role="form" method="POST" action={{ route('motifs.update', $motif) }}>
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group{{ $errors->has('motif') ? ' has-danger' : '' }} mb-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control{{ $errors->has('motif') ? ' is-invalid' : '' }}"
                                placeholder="{{ __('Motif') }}" type="text" name="motif" value="{{ $motif->motif }}"
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary my-4">{{ __('Mettre à jour') }}</button>
                    </div>
                </form>
            </div>
        </div>
