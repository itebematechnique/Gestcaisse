...
{{--                                <li class="breadcrumb-item"><a href="{{ route('home')  }}"><i class="fas fa-home"></i></a></li>--}}
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('financings.index') }}" class="btn btn-sm btn-neutral">Liste</a>
    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <h3 class="mb-0">Ajouter une source de financement</h3>
        </div>
        <!-- Form -->
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                <form role="form" method="POST" action="{{ route('financings.store') }}">
                    @csrf
                    ...
                    <div class="form-group{{ $errors->has('source') ? ' has-danger' : '' }} mb-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control{{ $errors->has('source') ? ' is-invalid' : '' }}"
                                placeholder="{{ __('source') }}" type="text" name="source" value="{{ old('source') }}"
